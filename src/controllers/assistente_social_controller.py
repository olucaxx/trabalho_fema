...
from views.assistente_social import tabela_assistentes_view, cadastro_assistente_view, atualizar_assistente_view

class AssistenteSocialController:
    def __init__(self, root):
        self.root = root
        self.model = assistente_social_model.AssistenteSocial()
        self.view_assistentes = tabela_assistentes_view.TabelaAssistentesView(self.root, self)
