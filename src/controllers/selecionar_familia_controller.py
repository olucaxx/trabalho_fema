...
from views.familia import selecionar_familia_view, atualizar_familia_view, cadastro_familia_view

class SelecionarFamiliaController:
    def __init__(self, root, aluno_controller):
        self.root = root
        self.model = familia_model.Familia()
        self.aluno_controller = aluno_controller
        self.view_familias = selecionar_familia_view.TabelaFamiliasView(self.root, self)
    ...
    def selecionar_familia(self):
        self.aluno_controller.atualizar_id_familia(self.view_familias.tabela.item(self.view_familias.tabela.selection())['values'][0])