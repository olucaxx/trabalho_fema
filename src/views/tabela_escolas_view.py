...
class TabelaEscolasView:
    def __init__(self, master, controller):
        ...
        self.tabela = ttk.Treeview(master, columns=('id', 'nome', 'serie', 'diretor', 'endereco', 'celular'), show='headings')
        ...
        self.tabela.heading('serie', text='Série', anchor='w')
        ...
        self.tabela.column('serie', width=50, anchor='w')
    ...
    def exibir_escola(self, id, nome_escola, serie, diretor, endereco, celular):
        self.tabela.insert('', 'end', values=(id, nome_escola, serie, diretor, endereco, celular))
