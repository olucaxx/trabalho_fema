...
class TabelaEscolasView:
    def __init__(self, master, controller_escola):
        self.master = tk.Toplevel(master)
        self.controller = controller_escola
        ...
        self.botao_selecionar = tk.Button(self.frame_botoes, text="Selecionar", command= self.selecionar_escola)
        self.botao_selecionar.grid(row=0, column=5, padx=5)

        self.tabela = ttk.Treeview(self.master, columns=('id', 'nome', 'diretor', 'endereco', 'celular'), show='headings')
