...
class CadastroEscolaView:
    def __init__(self, root, controller):
        ...
        tk.Label(self.master, text="Série:").grid(row=1, column=0, padx=10, pady=10)
        self.serie_entry = tk.Entry(self.master, textvariable=self.serie)
        self.serie_entry.grid(row=1, column=1, padx=10, pady=10)
    ...
    def cadastrar(self):
        ...
        self.controller.cadastrar_escola(nome_escola, serie, diretor, endereco, celular)
